...
local BodyCaps = {
	...
	["models/fallout/ghoulferal_trooper_bodycap_leftleg.mdl"] = {
		bones = {"Bip01 L Calf","Bip01 L Foot"},
		boneCap = "Bip01 L Calf",
		att = "bodycap_leftleg",
		bodygroup = 1,
		hitbox = HITBOX_LEFTLEG
	},
	["models/fallout/ghoulferal_trooper_bodycap_rightleg.mdl"] = {
	...
	["models/fallout/ghoulferal_trooper_bodycap_leftarm.mdl"] = {
	...
	["models/fallout/ghoulferal_trooper_bodycap_rightarm.mdl"] = {
...
ENT.sModel = "models/fallout/ghoulferal_trooper.mdl"
ENT.skName = "ghoulferal_trooper"
